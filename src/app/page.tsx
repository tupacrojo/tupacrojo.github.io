...
export default function Home() {
      ...
      if (!isScrolling) {
        ...
        setTimeout(() => {
          ...
          sections.forEach((section) => {
            if (
              Math.abs(section.offsetTop - scrollPosition) <
  ...
  return (
    <>
      ...
      >
        <div className="image-container flex w-64 h-64 group rounded-full border-4 border-orange-700">
          <Image
            src="/TupirfilBYN.png"
            width={698}
            height={698}
        ...
        <div className="flex-col">
          <h1 className="font-bold text-6xl cursor-default">
            Tupac
            <br />
            Rodríguez
          </h1>
          <div className="flex-row pt-4 space-x-2">
            <button
              onClick={() => {
                window.open(
                  "https://www.youtube.com/channel/UCalW6c_G8Lzh5_VgEMl5cQQ"
                );
              }}
              type="button"
            ...
            <button
              onClick={() => {
                window.open("https://wa.me/5492233030664");
              }}
              type="button"
              className="text-orange-700 border border-orange-700 hover:bg-orange-700 hover:text-white focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center dark:border-orange-500 dark:text-orange-500 dark:hover:text-white dark:focus:ring-orange-800 dark:hover:bg-orange-500"
            >
            ...
            <button
              onClick={() => {
                window.open("https://www.instagram.com/tupacrodriguez/");
              }}
              type="button"
              className="text-orange-700 border border-orange-700 hover:bg-orange-700 hover:text-white focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center dark:border-orange-500 dark:text-orange-500 dark:hover:text-white dark:focus:ring-orange-800 dark:hover:bg-orange-500"
            >
            ...
            <button
              onClick={() => {
                window.open("https://github.com/tupacrojo");
              }}
              type="button"
              className="text-orange-700 border border-orange-700 hover:bg-orange-700 hover:text-white focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center dark:border-orange-500 dark:text-orange-500 dark:hover:text-white dark:focus:ring-orange-800 dark:hover:bg-orange-500"
            >
            ...
            <button
              onClick={() => {
                window.open("https://www.linkedin.com/in/tupacrodriguez/");
              }}
              type="button"
              className="text-orange-700 border border-orange-700 hover:bg-orange-700 hover:text-white focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center dark:border-orange-500 dark:text-orange-500 dark:hover:text-white dark:focus:ring-orange-800 dark:hover:bg-orange-500"
            >
            ...
            <button
              onClick={() => {
                window.open("mailto:tupacrodriguez2003@gmail.com");
              }}
              type="button"
              className="text-orange-700 border border-orange-700 hover:bg-orange-700 hover:text-white focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center dark:border-orange-500 dark:text-orange-500 dark:hover:text-white dark:focus:ring-orange-800 dark:hover:bg-orange-500"
            >
